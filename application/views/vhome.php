  ...
  <body>
    ...
    $(document).on('click','#start', function(){
      ...
      if (learnData.length < 10) {
        ...
        console.log("Waktu untuk Training no Hidden layer selama " + (t1 - t0) + " milliseconds.");
        var t2 = performance.now();
        trainHidden();
        var t3 = performance.now();
        console.log("Waktu untuk Training one Hidden layer selama " + (t3 - t2) + " milliseconds.");
        var t4 = performance.now();
        trainDeep();
        var t5 = performance.now();
        console.log("Waktu untuk Training two Hidden layer selama " + (t5 - t4) + " milliseconds.");
        var t6 = performance.now();
        trainLSTM();
        var t7 = performance.now();
        console.log("Waktu untuk Training LSTM (10 Iterasi) selama " + (t7 - t6) + " milliseconds.");
